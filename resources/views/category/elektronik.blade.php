                        ...
                        <ul class="navbar-nav m-auto">
                            <li class="nav-item text-center">
                                <div class="nav-link">
                                    ...
                                    <span class="bold">Elektronik</span>
                                </div>
                            </li>
                        </ul>
        ...
        <div class="container banner">
            <div class="row">
                <div class="col text-center">
                    <img src="{{asset('img/elektronik.svg')}}" alt="..." class="img-thumbnail p-5"
                        style="max-width: 200px; border: none;" data-aos="fade-down">
                    <p class="display-4 bold text-center">Elektronik</p>
                </div>
            </div>
        </div>
        {{-- search --}}
        <section class="search-section">
            <div class="container search" id="search">
                <div class="row d-flex justify-content-center">
                    <div class="col-6">
                        <form action="/lelang/elektronik" method="GET">
                            ...
                            <div class="row g-0">
                                <div class="col-md-4 d-flex justify-content-center">
                                    ...
                                    <div class="bg-dark rounded"
                                        style="width: 200px; height: 200px; background-image: url('{{asset('img/'.$item->img)}}'); background-size: cover; background-position: center;">
                                    </div>
                                </div>
                                <div class="col-md-8">
                                    <div class="card-body">
                                        <a href="/lelang/{{$parameter}}/detail"
                                            class="card-title bold h5 stretched-link text-decoration-none text-reset text-of">{{$item->nama}}</a>
                                        <p class="card-text text-of">{{$item->desc}}</p>
                                        <p class="card-text fs-5 bold">IDR {{number_format($item->price,0,",",".")}}</p>
                                    </div>
                                </div>
                            </div>
                        </div>
