                        ...
                        <ul class="navbar-nav m-auto">
                            <li class="nav-item text-center">
                                <div class="nav-link">
                                    ...
                                    <span class="bold">Rumah Tangga</span>
                                </div>
                            </li>
                        </ul>
        ...
        <div class="container banner">
            <div class="row">
                <div class="col text-center">
                    <img src="{{asset('img/rumahtangga.svg')}}" alt="..." class="img-thumbnail p-5"
                        style="max-width: 200px; border: none;" data-aos="fade-down">
                    <p class="display-4 bold text-center">Rumah Tangga</p>
                </div>
            </div>
        </div>
        {{-- search --}}
        <section class="search-section">
            <div class="container search" id="search">
                <div class="row d-flex justify-content-center">
                    <div class="col-6">
                        <form action="/lelang/rumahtangga" method="GET">
